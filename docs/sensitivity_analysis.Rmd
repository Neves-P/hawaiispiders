...
age_input_rank <- data.frame(lapply(age_sens, "[[", 1))
age_model_rank <- data.frame(lapply(age_sens, "[[", 2))
knitr::kable(rbind(age_input_rank, age_model_rank))
...
rate_input_rank <- data.frame(lapply(rate_sens, "[[", 1))
rate_model_rank <- data.frame(lapply(rate_sens, "[[", 2))
knitr::kable(rbind(rate_input_rank, rate_model_rank))
...
m_age_input_rank <- data.frame(lapply(m_age_sens, "[[", 1))
m_age_model_rank <- data.frame(lapply(m_age_sens, "[[", 2))
knitr::kable(rbind(m_age_input_rank, m_age_model_rank))
```
