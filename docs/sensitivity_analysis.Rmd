...
```{r Plot, echo=FALSE}
data("r_c_no", package = "hawaiispiders")
DAISIE::DAISIE_plot_island(r_c_no)

data("a_c_no", package = "hawaiispiders")
DAISIE::DAISIE_plot_island(a_c_no)
```
**Figures 1 to 4. Input island data plots with all colonising lineages. Fig 1. r_c_no scenario; Fig 2. a_c_no scenario**
...
**Table 1. Parameter estimates obtained for the best model of each scenario.**
