...
#' DAISIE object of spiders on Hawaii (Big Island)
#'
#' A DAISIE object as required by [DAISIE::DAISIE_ML()]. Generated by running
#' [DAISIE::DAISIE_dataprep()] on [spider_scenario_1_datatable].
#'
