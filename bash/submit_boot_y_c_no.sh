...
#
# sbatch --dependency=singleton --job-name=b-y_c_no DAISIEutils/bash/submit_bootstrap.sh y_c_no cr_dd_0laa hawaiispiders 1
#
# sbatch --dependency=singleton --job-name=b-y_c_no DAISIEutils/bash/submit_bootstrap.sh y_c_no cr_dd_0lac hawaiispiders 1
#
# sbatch --dependency=singleton --job-name=b-y_c_no DAISIEutils/bash/submit_bootstrap.sh y_c_no cr_di_0lac hawaiispiders 1
